...
cl -DINTERNAL_BUILD=1 -DSLOW_BUILD=1 -DHANDMADE_WIN32=1 -W4 -WX -wd4201 -wd4100 -GR- -EHa- -Oi -Fmwin32_handmade.map  -Zi C:\Users\Roger\Desktop\Roger\handmade\RogerHandmade\code\win32_handmade.cpp user32.lib gdi32.lib
